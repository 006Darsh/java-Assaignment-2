...
public class Darsh2_5main {
    public static void main(String[] args) {
        ...
        Darsh2_5.information(roll_no_std, name_std, branch_std);//accordingly using both information methods.
        System.out.println("------------------------------------------------------------------");
        System.out.println("The given information of professor is  :");
        Darsh2_5.information(name_pro, degree_pro, faculty_of_pro, experience, salary);
    }
}
